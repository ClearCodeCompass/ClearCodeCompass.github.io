...
打开[restaurant.csv](restaurant.csv)

去除最近一个月接待人数大于等于1200人的数据

所有星级为3的改为1星，所有星级为4的改为3

算出 总的平均星级和各个城市的平均星级

增加一条数据：上海 人民饭店 ¥150-300 5  900 沪式糕点

使用柱状图展示不同辖区的平均"人均价格”，柱状图中的每个柱子代表一个辖区，高度代表该地区的平均价格 